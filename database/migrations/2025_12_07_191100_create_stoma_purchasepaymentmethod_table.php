...
return new class extends Migration
{
    ...
    {
        Schema::create('stoma_purchasepaymentmethod', function (Blueprint $table) {
            $table->increments('purchasepaymentmethodid');
    ...
    {
        Schema::dropIfExists('stoma_purchasepaymentmethod');
    }
};
