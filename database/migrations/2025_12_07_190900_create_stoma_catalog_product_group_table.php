...
return new class extends Migration
{
    ...
    {
        Schema::create('stoma_catalog_product_group', function (Blueprint $table) {
            $table->increments('catalog_product_groupid');
            $table->string('catalog_product_group_name', 255);
    ...
    {
        Schema::dropIfExists('stoma_catalog_product_group');
    }
};
