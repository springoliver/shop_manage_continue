@section('page_header', 'Add Store Category')
...
<x-admin-app-layout>
        ...
        <nav class="flex text-gray-500 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400"></i>
                        <span class="ml-1 font-medium text-gray-700 md:ml-2">Add Store Category</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <!-- Header -->
    <div class="mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Add Store Category</h1>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <!-- Card Body -->
        <div class="p-6">
            <form action="{{ route('admin.store-types.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="store_type" id="store_type" value="{{ old('store_type') }}"
