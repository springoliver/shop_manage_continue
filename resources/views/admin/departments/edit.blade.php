        ...
        <nav class="flex text-gray-500 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400"></i>
                        <span class="ml-1 font-medium text-gray-700 md:ml-2">Edit Department</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <div class="p-6">
            <form action="{{ route('admin.departments.update', $department) }}" method="POST" id="departmentForm">
                ...
                <div class="mb-6">
                    ...
                    <select name="storetypeid" id="storetypeid"
                        ...
                        @foreach($storeTypes as $storeType)
                            <option value="{{ $storeType->typeid }}" {{ old('storetypeid', $department->storetypeid) == $storeType->typeid ? 'selected' : '' }}>
                ...
                <div class="mb-6">
                    ...
                    <select name="storeid" id="storeid"
                        ...
                        @foreach($stores as $store)
                            <option value="{{ $store->storeid }}" {{ old('storeid', $department->storeid) == $store->storeid ? 'selected' : '' }}>
                                {{ $store->store_name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="department" id="department" value="{{ old('department', $department->department) }}" maxlength="255"
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="roster_max_time" id="roster_max_time" value="{{ old('roster_max_time', $department->roster_max_time) }}" min="0"
