            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ml-1 font-medium text-gray-700 md:ml-2">General Settings</span>
                    </div>
                </li>
            </ol>
        </nav>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($settings as $setting)
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900">{{ $setting->title }}</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900">{{ $setting->value }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <a href="{{ route('admin.settings.edit', $setting) }}" class="text-blue-600 hover:text-blue-900" title="Edit">
