        ...
        <nav class="flex text-gray-500 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400"></i>
                        <span class="ml-1 font-medium text-gray-700 md:ml-2">Add User Group</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-white border-b border-gray-200 px-6 py-4">
            <div class="flex items-center">
                ...
                <h3 class="text-lg font-semibold text-gray-800">User Group Information</h3>
            </div>
        </div>

        <!-- Card Body -->
        <div class="p-6">
            <form action="{{ route('admin.user-groups.store') }}" method="POST" id="userGroupForm">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="groupname" id="groupname" value="{{ old('groupname') }}" maxlength="255"
                ...
                <div class="mb-6">
                    ...
                    <select name="level_access" id="level_access"
                        ...
                        required>
                        <option value="Admin" {{ old('level_access') == 'Admin' ? 'selected' : '' }}>Admin</option>
                        <option value="View" {{ old('level_access') == 'View' ? 'selected' : '' }}>View</option>
                    </select>
                    @error('level_access')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
