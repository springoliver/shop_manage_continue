<x-storeowner-app-layout>
    ...
    <script>
        ...
        function initializePagination() {
            const tbody = document.getElementById('monthlyHoursTableBody');
            allRows = Array.from(tbody.querySelectorAll('tr.monthly-hours-row'));
            filteredRows = [...allRows];
            
            const noMonthlyHoursRow = document.getElementById('noMonthlyHoursRow');
            if (noMonthlyHoursRow && allRows.length > 0) {
                noMonthlyHoursRow.style.display = 'none';
            }
        ...
        function updateDisplay() {
            ...
            if (sortColumn && filteredRows.length > 0) {
                ...
                filteredRows.forEach(row => {
                    if (row.id !== 'noMonthlyHoursRow') {
                        if (noMonthlyHoursRow && noMonthlyHoursRow.parentNode) {
                            tbody.insertBefore(row, noMonthlyHoursRow);
                        } else {
            ...
            const noMonthlyHoursRow = document.getElementById('noMonthlyHoursRow');
            if (noMonthlyHoursRow) {
                if (filteredRows.length === 0) {
                    noMonthlyHoursRow.style.display = '';
                } else {
                    noMonthlyHoursRow.style.display = 'none';
                }
            }
            ...
            for (let i = start; i < end; i++) {
                if (filteredRows[i] && filteredRows[i].id !== 'noMonthlyHoursRow') {
