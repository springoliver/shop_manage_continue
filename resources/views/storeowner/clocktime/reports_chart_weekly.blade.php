        ...
        (function() {
            ...
            function initChart() {
                ...
                $(document).ready(function() {
                    // Fetch chart data
                    fetch('{{ route('storeowner.clocktime.get_hours_chart_weekly') }}', {
                        method: 'POST',
                        headers: {
                    ...
                    .then(data => {
                        ...
                        createBarChart('bar_chart', 'Company Performance - Weekly Total Employee Hours', chartData, 'Total Hours', '#3b82f6');
                    })
                    .catch(error => {
        ...
        function createBarChart(containerId, title, data, yLabel, barColor = '#3b82f6') {
            ...
            data.forEach((item, index) => {
                ...
                rect.addEventListener('mouseenter', function(e) {
                    ...
                    tooltip.innerHTML = `
                        <div style="font-weight: 600; margin-bottom: 4px; color: #333;">Week ${item.label}</div>
