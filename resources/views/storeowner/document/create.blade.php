            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('storeowner.document.index') }}" class="ml-1 hover:text-gray-700">Document</a>
                    </div>
                </li>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-2xl font-semibold text-gray-800 mb-6">Add Document</h2>
                
                <form action="{{ route('storeowner.document.store') }}" method="POST" enctype="multipart/form-data" id="myform">
                    @csrf
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <input type="file" name="doc" id="doc" 
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500" 
                                   required>
                            <p class="mt-2 text-sm text-gray-500">Allowed types: jpg, jpeg, png, pdf, doc, docx (Max: 50MB)</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-end gap-4 mt-8">
                        ...
                        <a href="{{ route('storeowner.document.index') }}" 
