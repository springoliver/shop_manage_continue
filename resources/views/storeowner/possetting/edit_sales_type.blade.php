<x-storeowner-app-layout>
        ...
        <nav class="flex text-gray-500 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400"></i>
                        <a href="{{ route('storeowner.possetting.sales-types') }}" class="ml-1 hover:text-gray-700">Sales Types</a>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Edit Sales Type Form -->
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-2xl font-semibold text-gray-800 mb-6">
                    <i class="fas fa-align-justify mr-2"></i> Edit Sales Type
                </h2>
                
                <form action="{{ route('storeowner.possetting.update-sales-types') }}" method="POST" id="myform">
                    @csrf
                    <input type="hidden" name="pos_sales_types_id" value="{{ base64_encode($salesType->pos_sales_types_id) }}">
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <input type="text" name="pos_sales_type_name" id="pos_sales_type_name" 
                                   value="{{ old('pos_sales_type_name', $salesType->pos_sales_type_name) }}"
