<div class="mb-4 flex flex-wrap gap-2">
    ...
    <a href="{{ route('storeowner.storecatalog.settings') }}" class="px-3 py-2 rounded {{ request()->routeIs('storeowner.storecatalog.settings') ? 'bg-gray-800 text-white' : 'bg-gray-100 text-gray-800' }}">Group</a>
