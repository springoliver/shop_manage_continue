                ...
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table id="table-new" class="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr class="bg-gray-50">
                                    <th scope="col" class="pr-0 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider sortable" data-sort="product" style="cursor: pointer;">
                                        Product <span class="sort-indicator"><i class="fas fa-sort text-gray-400"></i></span>
                                    </th>
                                    <th scope="col" class="pr-0 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider sortable" data-sort="measure" style="cursor: pointer;">
                                        Purchase Measure <span class="sort-indicator"><i class="fas fa-sort text-gray-400"></i></span>
                                    </th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="productTableBody">
                                @forelse ($storeProducts as $product)
                                    <tr class="product-row hover:bg-gray-50" 
                                        ...
                                        data-product="{{ strtolower($product->product_name ?? '') }}"
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900" title="{{ $product->product_price }}">
