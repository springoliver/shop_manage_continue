        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow p-6">
                <h2 class="text-2xl font-semibold text-gray-800 mb-6">
                    <i class="fas fa-edit mr-2"></i> Suppliers
                </h2>
                
                <form action="{{ route('storeowner.suppliers.update') }}" method="POST" id="myform">
                    @csrf
                    <input type="hidden" name="supplierid" value="{{ base64_encode($storeSupplier->supplierid) }}">
                        ...
                        <div class="w-3/4">
                            <select name="departmentid" id="departmentid" 
                                ...
                                @foreach($departments as $department)
                                    <option value="{{ $department->departmentid }}" {{ (old('departmentid', $storeSupplier->departmentid) == $department->departmentid) ? 'selected' : '' }}>
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <label class="inline-flex items-center mr-4">
                                <input type="radio" name="purchase_supplier" value="Yes" {{ old('purchase_supplier', $storeSupplier->purchase_supplier) == 'Yes' ? 'checked' : '' }} class="mr-2" required>
                                <span>Yes</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="purchase_supplier" value="No" {{ old('purchase_supplier', $storeSupplier->purchase_supplier) == 'No' ? 'checked' : '' }} class="mr-2" required>
                                <span>No</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <input type="text" name="supplier_name" id="supplier_name" 
                                   value="{{ old('supplier_name', $storeSupplier->supplier_name) }}"
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <input type="text" name="supplier_phone" id="supplier_phone" 
                                   value="{{ old('supplier_phone', $storeSupplier->supplier_phone) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500" 
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <input type="text" name="supplier_phone2" id="supplier_phone2" 
                                   value="{{ old('supplier_phone2', $storeSupplier->supplier_phone2) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500" 
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <input type="email" name="supplier_email" id="supplier_email" 
                                   value="{{ old('supplier_email', $storeSupplier->supplier_email) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500" 
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <input type="text" name="supplier_rep" id="supplier_rep" 
                                   value="{{ old('supplier_rep', $storeSupplier->supplier_rep) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500" 
                                   required>
                        </div>
                    </div>
