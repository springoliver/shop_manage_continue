        ...
        <nav class="flex text-gray-500 text-sm" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        <i class="fas fa-chevron-right text-gray-400"></i>
                        <span class="ml-1 font-medium text-gray-700 md:ml-2">Edit Tax Setting</span>
                    </div>
                </li>
            </ol>
        </nav>
    ...
    <div class="py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form action="{{ route('storeowner.suppliers.update-tax') }}" method="POST">
                    @csrf
                    <input type="hidden" name="taxid" value="{{ base64_encode($tax->taxid) }}">
                    ...
                    <div class="flex items-start gap-4 mb-6">
                        ...
                        <div class="w-3/4">
                            <input type="text" name="tax_amount" id="tax_amount" 
                                   value="{{ old('tax_amount', $tax->tax_amount) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500" 
                                   required>
                        </div>
                    </div>
